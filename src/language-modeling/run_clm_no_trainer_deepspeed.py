...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='The integration to report the results and logs to. Supported platforms are\
            `"comet_ml"`, `"tensorboard"` and `"wandb"`. Use `"all"` to report to all integrations.',
    )
...
def main():
    ...
    # torch.optim.AdamW(optimizer_grouped_parameters, lr=args.learning_rate)
    ...
    kwargs["train_micro_batch_size_per_gpu"] = args.per_device_train_batch_size
